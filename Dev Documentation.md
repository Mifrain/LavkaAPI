...
для самостоятельной работы по индивидуальному плану  
по курсу  
«Проектный семинар “Python в науке о данных”»

### Студенты группы БИВ239

- **Гилядов Борис Равашиевич**, brgiliadov@edu.hse.ru, +7 (925) 717-76-74.

### Тема работы:

API для заказов продуктов из магазина
